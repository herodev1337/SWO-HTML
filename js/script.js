...
//Sets the padding because of the Navbar
$(document).ready(function() {
    $('.main-container').css('padding-top', $('nav').css("height"));
});

//Makes the Navbar look cool
window.onscroll = function() {
    if (document.body.scrollTop > 80 || document.documentElement.scrollTop > 80) {
        $('*[class^="nav-caption"]').each(function(index) {
            $(this).addClass('nav-shrink');
            $(this).removeClass('nav-grow');
        });
        $('.main-container').css('padding-top', parseInt($('nav').css("height"))-30);
    } else {
        $('*[class^="nav-caption"]').each(function(index) {
            $(this).addClass('nav-grow');
...
//Activates the Bootstrap scrollspy
...
//Looks if element is in viewport
...
//Array to save the progressbar elements
let pgb = [];
...
//Get all Elements with "progress-animated-*" and let the observer watch them
